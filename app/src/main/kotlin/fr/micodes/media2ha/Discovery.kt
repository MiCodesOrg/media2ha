...
class Discovery(
    ...
    fun payload(): String {
        ...
        return JSONObject()
            ...
            .put("state_summary_topic", topics.summary)
            .put("state_season_topic", topics.season)
            .put("state_episode_topic", topics.episode)
            .put("state_series_topic", topics.series)
            .put("state_year_topic", topics.year)
